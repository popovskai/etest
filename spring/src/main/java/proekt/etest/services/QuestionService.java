...
public class QuestionService {
    ...
    public void setRightAnswer(Answer answer, Long question_id) {
        Question question = findQuestionById(question_id);
        Answer answerFound = answerService.findAnswerById(answer.getId());
        question.setRightAnswer(answerFound);
